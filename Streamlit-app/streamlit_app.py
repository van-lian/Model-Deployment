...
@st.cache_resource
def load_model():
    # SAS URL with embedded access token
    sas_url = "https://forproject112.blob.core.windows.net/model-deployment/random_forest_model.pkl?sp=r&st=2025-04-18T12:53:38Z&se=2025-04-18T20:53:38Z&spr=https&sv=2024-11-04&sr=b&sig=gxyr%2BlB3KGYf%2Fq10HT6xeVmj5QQTZ3v8CNOuwCBmtkw%3D"
...
if 'model' not in st.session_state:
    try:
        ...
        with open('scaler.pkl', 'rb') as file:
            st.session_state.scaler = pickle.load(file)
        with open('feature_names.pkl', 'rb') as file:
            st.session_state.features = pickle.load(file)
    except Exception as e:
